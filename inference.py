...
parser.add_argument('--task_id', type=str, required=True, help='Unique task identifier') 
...
def main():
    ...
    if not args.audio.endswith('.wav'):
        ...
        temp_audio_path = f'temp/temp_{args.task_id}.wav'  # Use task_id for unique temp file
